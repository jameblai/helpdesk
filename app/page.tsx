...
export default function GamePage() {
  const ticket = useGame((state) =>
    state.selectedTicketId ? state.ticketsById[state.selectedTicketId] : null,
  );
    ...
    return (
      <Container className="py-4 md:py-8">
        <article className="prose">
          ...
          <p>
            Keep the helpdesk running by reviewing each incoming ticket before
            it expires.
          </p>
          <ul>
            <li>
            ...
            <li>
              Use the manual to find the correct advice for the situation.
            </li>
